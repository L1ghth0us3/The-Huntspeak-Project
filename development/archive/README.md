# Private working sources (local only)

This directory holds **private, unpublished** working documents that the lexicon and docs were imported from. They are **not part of the git repository** (see the root `.gitignore`).

| Local file (if present) | Provenance key(s) in the lexicon |
| --- | --- |
| `Huntspeak.md` | `base-dict`, `base-grammar`, `base-notes` |
| `Huntspeak (LLM enhanced).md` | `enhanced` |
| `Huntspeak_CheatSheet.md` | `cheatsheet` |
