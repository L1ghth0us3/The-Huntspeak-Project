# 4. Prefix Verbs, Negation, and Verb Combinations

## The irregular "prefix verbs"

A handful of the most basic verbs are irregular. Instead of a consonantal skeleton, each is a **prefix attached directly to its object or complement**:

| Prefix | Meaning | Example |
| --- | --- | --- |
| **v-** | to have, to own | `vaqäsh` "has love" |
| **sh-** | to be | `shaqin` "is (a) queen" |
| **kh-** | to hunt | `khatye` "hunts (an) animal" |
| **r-** | to do | `rashiroth` "makes a journey" |
| **d-** | to cause | `danenad` "causes to move" |
| **s-** | can, to be able to | |
| **sh-d-** | to become | `shudu-` "became (long ago)" |
...
**naaq** is the word for "no", and as a prefix it negates:
...
The prefix verb **d-** "cause" builds causatives. In a simple sentence:

> **Î danenad tye.**
> I cause-move animal
> "I cause the animal to move."

The prefix `da-` carries only the tense vowel (decision D8); the embedded verb `nenad` conjugates for its own subject (the animal, third person, hence its *e*).

With more participants the extra verbs move to the end, keeping their order (S V O O V):

> **Î mîvat su tye danenad.**
> I trust you animal cause-move
> "I trust you to cause the animal to move."

## Auxiliary verbs: -ba

When one verb supports another ("want to eat", "try to hunt"), the **auxiliary** takes the suffix **-ba** and the main verb conjugates normally:

> **Î qîrad-ba lîba qäru.**
> I want-AUX eat food
> "I want to eat food."

Here `q-r-d` "want" is the auxiliary (hence `qîrad-ba`) and `l-b-` "eat" is the main verb.
