...
A few everyday verbs don’t use a three-consonant skeleton. Each is a **prefix stuck to its object or complement**:
...
**d-** “cause” builds causatives:

> **Î danenad tye.**
> I cause-move animal
> “I cause the animal to move.”

`da-` carries only the tense vowel; the embedded verb (`nenad`) conjugates for *its* subject (the animal → *e*).

With more participants, extra verbs trail at the end (S V O O V):
...
When one verb supports another (“want to eat”), the **helper** takes **-ba** and the main verb conjugates normally:
